        ...
        <DashboardShell>
            <div className="mx-auto max-w-2xl overflow-hidden rounded-3xl border border-emerald-200 bg-white shadow-xl">
                <div className="bg-emerald-600 px-8 py-10 text-center text-white">
                    ...
                    <p className="mt-2 text-emerald-100">Your Khalti payment was verified and recorded.</p>
                </div>
                <div className="p-8">
                    <div className="grid gap-4 rounded-2xl bg-zinc-50 p-5 sm:grid-cols-2">
                        ...
                        <div><p className="text-xs uppercase tracking-wide text-zinc-500">Payment method</p><p className="mt-1 font-bold">Khalti</p></div>
